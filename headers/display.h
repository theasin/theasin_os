...
extern "C" {
    ...
    extern u16 res_x, res_y, bpp;
    extern bool rtlo, insanity;
    extern char buf[80 * 25];
    extern str tochar(u64, str);
    extern void term_init(), vbe_init();
    extern void term_fill(u8);
    ...
    extern void vbe_putc(char, int, int, u32, u32);
    extern unsigned char g_40x25_text[], g_40x50_text[], g_80x25_text[], g_80x50_text[], g_90x30_text[], g_90x60_text[], g_640x480x2[], g_320x200x4[], g_640x480x16[], g_720x480x16[], g_320x200x256[], g_320x200x256_modex[], g_8x16_font[];
}
#endif
