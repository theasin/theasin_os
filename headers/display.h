...
extern "C" {
    ...
    void fix_term()
    {
        //Made to fix the terminal if it hits negative vertical coords as a result of constant backspacing.
        //That might be a vulnerability because vga_buffer is just a pointer to address 0xB8000
        if (term_row<0)  {   term_col = 0;  term_row = 0;   }
    }
