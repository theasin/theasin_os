...
i686-elf-gcc -std=gnu++20 -ffreestanding -g -c display.cpp -o ./tmp/display.o -Wall -Wextra -fno-exceptions -fno-rtti
 i686-elf-gcc -std=gnu++20 -ffreestanding -g -c mouse.cpp -o ./tmp/mouse.o  -Wall -Wextra -fno-exceptions -fno-rtti
i686-elf-gcc -std=gnu++20 -ffreestanding -g -c kb_legacy.cpp -o ./tmp/kb_legacy.o -Wall -Wextra -fno-exceptions -fno-rtti
#i686-elf-gcc -ffreestanding -nostdlib -g -T linker.ld start.o kernel.o -o mykernel.elf --verbose -fno-use-linker-plugin
i686-elf-gcc -T linker.ld -o ./mykernel.bin -ffreestanding -O2 -nostdlib ./tmp/start.o ./tmp/kernel.o ./tmp/display.o ./tmp/kbd.o ./tmp/kutil.o ./tmp/mouse.o ./tmp/kb_legacy.o -lgcc -fno-use-linker-plugin 
